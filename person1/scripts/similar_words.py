...
class SimilarityIndex:
    ...
    def get_similar(self, word, k=5, len_radius=1, threshold=None):
        ...
        Returns list of dicts: word, dist, ipa, freq, n_utts.
        Excludes the query word itself. If the word cannot be tokenized,
        returns [].
        """
    ...
    if args.dump:
        ...
        with ProcessPoolExecutor(max_workers=jobs) as pool:
            ...
            with open(args.out, "w", encoding="utf-8", newline="") as fh:
                ...
                w.writerow(["word", "rank", "similar_word", "dist", "ipa", "freq", "n_utts"])
                n = 0
